...
description: Este artigo fornece informações para ajudá-lo a determinar o tipo correto de implantação do Project Operations para sua empresa.
author: stsporen
ms.date: 03/15/2021
ms.topic: article
