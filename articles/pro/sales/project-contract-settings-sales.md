---
title: Detalhes do cabeçalho para contratos de projeto
description: Este artigo fornece informações sobre os campos e informações sobre contratos de projeto no Project Operations.
author: rumant
ms.date: 03/08/2022
ms.topic: article
