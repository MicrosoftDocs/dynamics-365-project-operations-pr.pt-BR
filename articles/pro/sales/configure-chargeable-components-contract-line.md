...
description: Este artigo fornece informações sobre como adicionar componentes cobráveis a linhas de contrato no Project Operations.
author: rumant
ms.date: 10/08/2020
ms.topic: article
...
Uma linha de contrato de projeto tem componentes *incluídos* e componentes *passíveis de cobrança*.
