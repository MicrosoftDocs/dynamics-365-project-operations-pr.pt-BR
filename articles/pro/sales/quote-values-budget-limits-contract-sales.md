---
title: Resumo informativo de uma cotação de projeto (Sales)
...
ms.locfileid: "4071359"
---
# <a name="summary-information-on-a-project-quote-sales"></a>Resumo informativo de uma cotação de projeto (Sales)
