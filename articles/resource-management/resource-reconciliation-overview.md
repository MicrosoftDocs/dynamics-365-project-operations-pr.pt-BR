...
description: Este artigo fornece informações que ajudarão você a garantir que as reservas e atribuições de recursos para projetos estejam alinhadas.
author: ruhercul
ms.date: 01/08/2021
ms.topic: overview
ms.prod: ''
