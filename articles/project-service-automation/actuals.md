...
---
# <a name="actuals"></a>Dados Efetivos
...
## <a name="using-journals-to-record-costs"></a>Usando diários para registrar custos

No PSA, os diários permitem registrar custo ou receita nas classes de material, valor, hora, despesa ou transação de imposto. Um diário possui um cabeçalho, linhas e uma ação **Confirmar**. Veja a seguir alguns cenários onde você pode usar um diário:
