...
Procurando por recursos para ajudá-lo a planejar sua implementação? Veja essas diretrizes que você pode baixar.
 ...
 [Guia de planejamento e acompanhamento de projeto](../project-service/implementation-guides/project-planning-tracking.md)

 [Guia de cotação básica, preço e cobrança](../project-service/implementation-guides/begin-quoting-pricing-billing.md)

 [Guia de cotação avançado, preço e cobrança](../project-service/implementation-guides/adv-quoting-pricing-billing.md)

 [Guia do gerente de recursos](../project-service/implementation-guides/resource-management-guide.md)

 [Guia de Relatórios](../project-service/implementation-guides/reporting-guide.md)

 [Notas para desenvolvedores](../project-service/developer-guides/overview-dev-notes-v3.x.md)
...
## <a name="guidance-for-earlier-versions-app-version-2x-or-1x"></a>Diretrizes para as versões anteriores (versão de aplicativo 2.x ou 1.x)
 ...
 [Tempo, despesas e colaboração](../project-service/time-expense-collaboration-guide.md)

 [White papers (versão do aplicativo 2.x ou 1.x)](../project-service/white-papers.md)

 [Notas para desenvolvedores (versão 2.x do aplicativo)](../project-service/developer-guides/add-custom-qoi-forms-v2.x.md)
