...
[!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Instalar o Dynamics 365 for Phones e Dynamics 365 for Tablets](../mobile-app/install-dynamics-365-for-phones-and-tablets.md).
...
[!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Guia de noções básicas do aplicativo móvel](../mobile-app/dynamics-365-phones-tablets-users-guide.md).
