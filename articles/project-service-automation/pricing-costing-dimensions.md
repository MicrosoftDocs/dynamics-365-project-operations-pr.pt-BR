...
Por isso, há dois tipos de valor de dimensão de preço disponíveis no PSA (Project Service Automation): 

- **Conjuntos de opções**– dimensões que são enumerações fixas para um conjunto de valores.
- **Valores baseados em entidade** – dimensões que podem ser um variado conjunto de valores.
...
- [Configurar campos personalizados como dimensões de preço](set-up-pricing-dimensions.md)
