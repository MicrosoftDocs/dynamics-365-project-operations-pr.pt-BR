...
description: Este artigo explica como receber itens em uma ordem de compra de uma requisição de itens.
author: Yowelle
ms.date: 08/06/2019
...
Este artigo explica como receber itens em uma ordem de compra de uma requisição de itens.
