...
description: Este tópico fornece informações sobre a solução de integração do Dynamics 365 Project Service Automation para o Dynamics 365 Finance.
author: ruhercul
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
