...
description: Este artigo fornece exemplos de contratos de projeto que você pode criar para vários tipos de projetos e fontes de financiamento, e como você pode gerenciar contratos e faturar clientes do projeto.
author: Yowelle
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
