---
title: Detalhes do cabeçalho para cotações baseadas em projeto
description: Este artigo fornece informações sobre as informações e configurações que se aplicam e afetam cotações do projeto.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9825129"
---
# <a name="header-details-for-project-based-quotes"></a>Detalhes do cabeçalho para cotações baseadas em projeto
...
A tabela a seguir lista os campos de informações de resumo em uma cotação de projeto que são exclusivos do Dynamics 365 Project Operations ou que tenham algumas alterações importantes no comportamento das cotações do Dynamics 365 Sales.
