...
description: Este artigo fornece informações e exemplos que o ajudarão a usar os logs de Agendamento de Projeto para rastrear falhas relativas ao Serviço de Agendamento de Projeto e APIs de Agendamento de Projeto.
author: ruhercul
ms.date: 11/30/2021
ms.topic: article
