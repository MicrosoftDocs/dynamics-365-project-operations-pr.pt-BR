...
description: Este artigo explica como criar uma estrutura de detalhamento de trabalho (WBS) incluindo os controles básicos na nova interface de agendamento.
author: ruhercul
ms.date: 12/16/2021
ms.topic: article
