...
description: Este artigo descreve as considerações e as decisões que você deve tomar durante o processo de planejamento, antes de configurar o gerenciamento de despesas no Microsoft Dynamics 365 Finance.
author: KimANelson
ms.date: 08/29/2017
ms.topic: article
ms.prod: ''
