...
description: Este artigo explica como usar o sistema de fluxo de trabalho no Microsoft Dynamics 365 Finance para configurar um processo de revisão de relatórios de despesas no gerenciamento de despesas.
