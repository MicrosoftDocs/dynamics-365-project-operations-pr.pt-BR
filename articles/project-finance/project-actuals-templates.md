...
- Se você estiver criando um modelo, será necessário adicionar a coluna para oferecer suporte a tempo e despesas intercompanhia. Selecione **Adicionar Coluna Condicional** e insira um nome para a coluna, como **LegalEntity**. Insira uma condição para a coluna em que, se **msdyn\_contractorganizationalunitid.msdyn\_name** for \<unidade organizacional\>, \<insira a entidade legal\>; caso contrário, o valor será nulo.
