...
---
# <a name="manage-a-proforma-invoice"></a>Gerenciar uma fatura pro forma
...
| **Empresa de Recursos** | Definido por padrão a partir da fonte real. Um campo somente leitura que está bloqueado para edição. | O campo pode ser editado em um novo detalhe de linha de fatura que não é apoiado por uma fonte real. |
